...
public class RobotContainer {
    ...
    private RobotContainer() {
        ...
        SmartDashboard.putData("ChassisDriveCommand", new ChassisDriveCommand(m_chassis));
    ...
    private void configureButtonBindings() {
        ...
        final JoystickButton rightBumper = new JoystickButton(xboxController0,
        ...
        xButton.whileHeld(new ClimberRetractCommand(m_climber), true);
        ...
        yButton.whileHeld(new ClimberExtendCommand(m_climber), true);
